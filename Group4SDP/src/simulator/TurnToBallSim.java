...
public class TurnToBallSim {

	/*
	 * public static void main(String[] args) { double angle = findBearing(80,
	 * 20, 100, 10); System.out.println("Bearing to ball is: " + angle +
	 * " degrees."); double turnAngle = turnAngle(240, angle);
